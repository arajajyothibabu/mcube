	...
	<div class="page-header row">
        ...
        <?php
			if(isset($_SESSION['user'])){
				$size = 40;
				//<i class="fa fa-user"></i> instead of gravtar
			$img_url = "http://www.gravatar.com/avatar/" . md5( strtolower( trim( $_SESSION['user'] ) ) ) . "?d=mm" . "&s=" . $size;
				echo '<span class="dropdown account">
                <span href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="'.$img_url.'"> '.$_SESSION['user'].'<b class="caret"></b></span>
